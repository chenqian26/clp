...
<?php if(!$is_space) { ?><div class="comeing_ft"><?php } ?>
...
<?php } ?>
    ...
    <?php if(!$is_space) { ?></div><?php } } if(!$_G['setting']['bbclosed'] && !$_G['member']['freeze'] && !$_G['member']['groupexpiry']) { if($_G['uid'] && !isset($_G['cookie']['checkpm'])) { ?>
