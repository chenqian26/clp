...
0
|| checktplrefresh('./template/eis_city_c21/common/header.htm', './template/default/common/header_common.htm', 1426773727, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/eis_city_c21', 'common/header_forum_viewthread')
|| checktplrefresh('./template/eis_city_c21/common/header.htm', './template/eis_city_c21/common/pubsearchform.htm', 1426773727, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/eis_city_c21', 'common/header_forum_viewthread')
;?>
